                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">入职时间</th>
                                <th class="sorting_desc sorting_desc_disabled">职位</th>
                            ...
                            <c:forEach items="${empList}" var="emp">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/deptFindUserById?username=${emp.username}"
