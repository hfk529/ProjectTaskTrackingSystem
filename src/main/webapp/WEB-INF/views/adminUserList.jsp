                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">真实姓名</th>
                                <th class="sorting_desc sorting_desc_disabled">性别</th>
                                <th class="sorting">出生日期</th>
                                <th class="sorting">所属角色</th>
                            ...
                            <c:forEach items="${empList}" var="emp">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="showUser?username=${emp.username}"
                                           class="btn bg-olive btn-xs">查看</a>
                                        <a href="deleteUser?username=${emp.username}"
